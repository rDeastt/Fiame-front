...
import './historyPaymentClient.css'
export const BusinessItemHistory = ({ data, type }) => {
    ...
    return (
        <div className="business-item-history">
            <img src={"https://i.imgur.com/lAIwtsY.jpg"} alt="Business" className="business-image-history" />
            <div className="business-info-history">
                <p className="info-item-history">Negocio: {business.name}</p>
                <p className="info-item-history">RUC: {business.ruc}</p>
            ...
            <div className="action-container-history">
                ...
                <Link to={type === 'paymentplan' ? `/Client/Details/${data.id}` : `/Client/DetailsBagHistory/${data.client.id}/${business.id}`}>
